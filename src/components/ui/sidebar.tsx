...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "ml-auto h-5 min-w-5 flex items-center justify-center rounded-full bg-sidebar-primary px-2 text-xs font-medium tabular-nums text-sidebar-primary-foreground select-none pointer-events-none",
      "peer-hover/menu-button:text-sidebar-accent-foreground peer-data-[active=true]/menu-button:text-sidebar-accent-foreground",
      "group-data-[collapsible=icon]:absolute group-data-[collapsible=icon]:top-0.5 group-data-[collapsible=icon]:right-0.5 group-data-[collapsible=icon]:ml-0 group-data-[collapsible=icon]:h-4 group-data-[collapsible=icon]:min-w-4 group-data-[collapsible=icon]:text-[9px] group-data-[collapsible=icon]:p-0.5",
      className
    )}
    {...props}
  />
